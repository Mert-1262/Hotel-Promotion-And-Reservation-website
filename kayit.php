...
$ad_err = $soyad_err = $e_posta_err = $parola_err = $Telefon_err = $adres_err =$genel_err = ""; // Hata mesajları için değişkenler
if (isset($_POST["kaydet"])) {
    ...
    if (empty($_POST["telefon"])) {
        $Telefon_err = "Telefon boş geçilemez.";
    } elseif (strlen($_POST["telefon"]) != 11) {
        $Telefon_err = "telefon 11 haneden oluşmalıdır.";
    } else {
    ...
    if (empty($ad_err) && empty($soyad_err) && empty($e_posta_err) && empty($parola_err)) {
        ...
        $ekle = "INSERT INTO tbl_kullanicilar (ad, soyad, e_posta, sifre, telefon, adres) VALUES ('$isim','$soyisim','$email','$hashed_password', '$telefon', '$adres')";
    ...
    <div class="box">
        <form method="POST" autocomplete="off">
            ...
            <div class="inputBox">
                ...
                <span>Telefon</span>
                <i></i>
                <div class="error"><?php echo $Telefon_err; ?></div> <!-- Telefon hata mesajı -->
            </div>
            <div class="inputBox">
                <input type="text" name="adres" required="required">
                <span>Adres</span>
                <i></i>
                <div class="error"><?php echo $adres_err; ?></div> <!-- Adres hata mesajı -->
            </div>            
            <div class="inputBox">
