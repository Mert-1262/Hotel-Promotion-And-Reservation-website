...
<head>
    ...
    justify-items: center; /* Resimleri yatay olarak ortala */
}
        ...
        .image img {
    width: 100%; /* Resmi kapsayıcıya tam oturt */
    height: auto; /* Yüksekliği oranla belirle */
    aspect-ratio: 16 / 9; /* Genişlik-yükseklik oranını ayarla */
    object-fit: cover; /* Resmin çerçeveye tam oturmasını sağla */
    ...
    margin-bottom: 20px;
    width: 250px; /* Konteyner genişliği */
    height: auto; /* Görselin içeriğe göre yüksekliği */
    display: inline-block; /* Görselleri yan yana sıralamak için */
}

.image-container img {
    width: 100%; /* Görsel genişliğini kapsayıcıya eşitle */
    height: 150px; /* Görsel yüksekliğini sabitle */
    object-fit: cover; /* Görseli düzgün kes */
...
.caption {
    margin-top: 10px; /* Görsel ile yazı arasındaki boşluk */
